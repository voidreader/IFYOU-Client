    ...
    public static class EditorMicroAnimations
    {
        ...
        public static class Reactor
        {
            public static class Icons
            {
                ...
                public static List<Texture2D> ProgressTargetAction => s_ProgressTargetAction = s_ProgressTargetAction ?? GetTextures(AnimationName.ProgressTargetAction);
                private static List<Texture2D> s_ProgressTargetAnimator;
                public static List<Texture2D> ProgressTargetAnimator => s_ProgressTargetAnimator = s_ProgressTargetAnimator ?? GetTextures(AnimationName.ProgressTargetAnimator);
                private static List<Texture2D> s_ProgressTargetImage;
                public static List<Texture2D> ProgressTargetImage => s_ProgressTargetImage = s_ProgressTargetImage ?? GetTextures(AnimationName.ProgressTargetImage);
                private static List<Texture2D> s_ProgressTargetText;
