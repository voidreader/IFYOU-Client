...
namespace Doozy.Runtime.UIManager.UIMenu
{
    ...
    public class UIMenuCamera : MonoBehaviour
    {
        ...
        private static float GetTickInterval(int fps) => 1f / (Mathf.Max(MIN_FPS, fps) * FPS_FREQUENCY_MODIFIER);
        ...
        public bool AutoDeleteFilesFromTargetPath = false;
        ...
        private void Awake()
        {
            ...
            #if INPUT_SYSTEM_PACKAGE
            {
                ...
                m_Space.performed += ctx => StartStopMultiShot();
            }
            #endif
        }
