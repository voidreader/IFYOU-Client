...
public class CameraPlay_BloodHit : MonoBehaviour
{
    ...
    public void SettingValue(float rnd, float x, float y)
    {
        rR = rnd;
        rX = x;
        rY = y;
    ...
    void SettingTexture(float r)
    {
        switch (r)
        {
            case 0:
                Texture2 = Resources.Load("CameraPlay_Blood_Anm1") as Texture2D;
                break;
            case 1:
                Texture2 = Resources.Load("CameraPlay_Blood_Anm3") as Texture2D;
                break;
            case 2:
                Texture2 = Resources.Load("CameraPlay_Blood_Anm4") as Texture2D;
                break;
            case 3:
                Texture2 = Resources.Load("CameraPlay_Blood_Anm7") as Texture2D;
                break;
        }
    }
