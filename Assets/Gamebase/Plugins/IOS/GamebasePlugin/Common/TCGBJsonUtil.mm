...
@implementation TCGBJsonUtil

+(TCGBJsonUtil*)sharedGamebaseJsonUtil {
    static dispatch_once_t onceToken;
    static TCGBJsonUtil* instance = nil;
    dispatch_once(&onceToken, ^{
        instance = [[TCGBJsonUtil alloc] init];
    });
    return instance;
}
...
-(NSString*)prettyJsonStringFromObject:(NSObject*)src {
    NSMutableDictionary* jsonDictionary = [[TCGBJsonUtil sharedGamebaseJsonUtil] mutableDictionaryFromObject:src];
