		...
		public override void Execute()
		{
		    ...
		    try
		    {
			    ...
			    using (var nativeClass = new AndroidJavaClass(classPath))
			    {
				    ...
				    var filters = FilteringData.GetFileFiltersAndroid(il2cpp);
					nativeClass.CallStatic("GetCodeHash", GenerateStringArrayFromFilters(filters.Includes), new CodeHashGeneratorCallback(this));
			    }
		    }
		    catch (Exception e)
		    {
