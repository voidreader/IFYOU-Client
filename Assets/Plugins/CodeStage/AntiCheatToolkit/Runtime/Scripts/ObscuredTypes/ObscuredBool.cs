...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public partial struct ObscuredBool : IObscuredType, IEquatable<ObscuredBool>, IComparable<ObscuredBool>, IComparable<bool>, IComparable
	{
		...
		[SerializeField] [FormerlySerializedAs("fakeValueChanged")]
		...
		{
			return obj is ObscuredBool o && Equals(o);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is bool b)) throw new ArgumentException("Argument must be boolean");
			return CompareTo(b);
#endif
		}
