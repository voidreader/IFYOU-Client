...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public partial struct ObscuredDouble : IObscuredType, IFormattable, IEquatable<ObscuredDouble>, IComparable<ObscuredDouble>, IComparable<double>, IComparable
	{
#if UNITY_EDITOR
...
#pragma warning restore 414
		...
		{
			return obj is ObscuredDouble od && Equals(od);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is double d)) throw new ArgumentException("Argument must be double");
			return CompareTo(d);
#endif
		}
