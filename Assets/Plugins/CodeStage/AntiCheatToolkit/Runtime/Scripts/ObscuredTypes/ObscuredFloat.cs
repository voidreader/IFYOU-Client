...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public partial struct ObscuredFloat : IObscuredType, IFormattable, IEquatable<ObscuredFloat>, IComparable<ObscuredFloat>, IComparable<float>, IComparable
	{
#if UNITY_EDITOR
...
#pragma warning restore 414
		...
		{
			return obj is ObscuredFloat of && Equals(of);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is float f)) throw new ArgumentException("Argument must be float");
			return CompareTo(f);
#endif
		}
