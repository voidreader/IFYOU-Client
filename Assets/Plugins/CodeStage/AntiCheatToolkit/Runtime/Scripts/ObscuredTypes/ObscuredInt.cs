...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public partial struct ObscuredInt : IObscuredType, IFormattable, IEquatable<ObscuredInt>, IComparable<ObscuredInt>, IComparable<int>, IComparable
	{
		...
		{
			return obj is ObscuredInt oi && Equals(oi);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is int i)) throw new ArgumentException("Argument must be int");
			return CompareTo(i);
#endif
		}
