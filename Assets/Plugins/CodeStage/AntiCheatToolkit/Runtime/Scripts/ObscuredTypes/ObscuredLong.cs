...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public partial struct ObscuredLong : IObscuredType, IFormattable, IEquatable<ObscuredLong>, IComparable<ObscuredLong>, IComparable<long>, IComparable
	{
		...
		{
			return obj is ObscuredLong o && Equals(o);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is long l)) throw new ArgumentException("Argument must be long");
			return CompareTo(l);
#endif
		}
		...
		public static long Encrypt(long value) { throw new Exception(); }

		[Obsolete("Please use new Decrypt(value, key) API instead.", true)]
		public static long Decrypt(long value) { throw new Exception(); }

		[Obsolete("Please use new FromEncrypted(encrypted, key) API instead.", true)]
		public static ObscuredLong FromEncrypted(long encrypted) { throw new Exception(); }
