...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public partial struct ObscuredShort : IObscuredType, IFormattable, IEquatable<ObscuredShort>, IComparable<ObscuredShort>, IComparable<short>, IComparable
	{
		...
		{
			return obj is ObscuredShort o && Equals(o);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is short s)) throw new ArgumentException("Argument must be short");
			return CompareTo(s);
#endif
		}
