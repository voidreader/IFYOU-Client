...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public sealed partial class ObscuredString : IObscuredType, IComparable<ObscuredString>, IComparable<string>, IComparable
	{
...
#pragma warning restore 0649
		...
		public bool Equals(ObscuredString value)
		{
			...
			return cryptoKey == value.cryptoKey ? 
				ArraysEquals(hiddenChars, value.hiddenChars) : 
				ArraysEquals(InternalDecrypt(), value.InternalDecrypt());
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is string s)) throw new ArgumentException("Argument must be string");
			return CompareTo(s);
#endif
		}
