...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public partial struct ObscuredUInt : IObscuredType, IFormattable, IEquatable<ObscuredUInt>, IComparable<ObscuredUInt>, IComparable<uint>, IComparable
	{
		...
		{
			return obj is ObscuredUInt o && Equals(o);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is uint u)) throw new ArgumentException("Argument must be uint");
			return CompareTo(u);
#endif
		}
