...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	[Serializable]
	public partial struct ObscuredULong : IObscuredType, IFormattable, IEquatable<ObscuredULong>, IComparable<ObscuredULong>, IComparable<ulong>, IComparable
	{
		...
		{
			return obj is ObscuredULong o && Equals(o);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is ulong u)) throw new ArgumentException("Argument must be ulong");
			return CompareTo(u);
#endif
		}
