...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	public struct ObscuredUShort : IObscuredType, IFormattable, IEquatable<ObscuredUShort>, IComparable<ObscuredUShort>, IComparable<ushort>, IComparable
	{
		...
		{
			return obj is ObscuredUShort o && Equals(o);
		}
		...
		public int CompareTo(object obj)
		{
			...
			if (!(obj is ushort u)) throw new ArgumentException("Argument must be ushort");
			return CompareTo(u);
#endif
		}
		...
		public static ushort EncryptDecrypt(ushort value) { throw new Exception(); }
		...
		public static ObscuredUShort FromEncrypted(ushort encrypted) { throw new Exception(); }

		[Obsolete("Please use new GetEncrypted(out key) API instead.", true)]
		public ushort GetEncrypted() { throw new Exception(); }
