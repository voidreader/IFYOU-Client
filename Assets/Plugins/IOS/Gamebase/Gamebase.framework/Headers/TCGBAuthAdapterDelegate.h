 ...
 */
- (void)loginWithSender:(id)sender target:(id<TCGBAuthAdapterDelegate>)target additionalInfo:(nullable NSDictionary *)additionalInfo viewController:(UIViewController *)viewController completion:(void(^)(id credential, TCGBError *error))completion;
...
/** Mapping to identity service provider.
 ...
 @param completion completion handler when auth process(login, logout, withdraw) is completed.
 */
- (void)addMappingWithSender:(id)sender target:(id<TCGBAuthAdapterDelegate>)target additionalInfo:(nullable NSDictionary *)additionalInfo viewController:(UIViewController *)viewController completion:(void(^)(id credential, TCGBError *error))completion;
