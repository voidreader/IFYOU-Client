 ...
 */
+ (nullable NSDictionary *)launchingInformations;

/**
 @return Launching Information related with TCGB launching service.
 */
+ (nullable NSDictionary *)TCGBLaunchingInformations;

/**
 @return Launching Information related with toast cloud product.
 */
+ (nullable NSDictionary *)tcProductInformations;
 ...
 */
+ (nullable NSArray *)tcIAPInformations;
@end
