...
/**
 ThirdIdPCode
 */
@property (nonatomic, strong) NSString*             thirdIdPCode;
 ...
 */
+ (TCGBProviderAuthToken *)authTokenWithSession:(NSString *)session;
...
/**
 ...
 @param thirdIdPCode Third IDP Code
 */
+ (TCGBProviderAuthToken *)authTokenWithAccessToken:(NSString *)accessToken refreshToken:(NSString *)refreshToken accessTokenSecret:(NSString *)accessTokenSecret expirationTime:(long)expirationTime thirdIdPCode:(NSString *)thirdIdPCode;
...
/**
 ...
 @param expirationTime Expiration Time
 */
+ (TCGBProviderAuthToken *)authTokenWithAccessToken:(NSString *)accessToken refreshToken:(NSString *)refreshToken accessTokenSecret:(NSString *)accessTokenSecret expirationTime:(long)expirationTime;
