...
#import "TCGBPurchaseVerifyItem.h"
...
+ (BOOL)purchaseWithWebSocket:(TCGBWebSocket *)websocket;
 ...
 */
+ (void)requestPurchaseWithItemSeq:(long)itemSeq viewController:(UIViewController *)viewController completion:(void(^)(TCGBPurchasableReceipt * _Nullable purchasableReceipt, TCGBError * _Nullable error))completion;
...
@param gamebaseProductId         gamebaseProductID which you want to purchase.
@param viewController  represent to current viewcontroller.
@param completion      completion may return the TCGBPurchasableReceipt instance.<br/>
If there is an error, TCGBError will be returned.
@warning   You should call this method after ```logged in```, otherwise you will get **TCGB_ERROR_NOT_LOGGED_IN** error in the completion.
...
*/
+ (void)requestPurchaseWithGamebaseProductId:(NSString *)gamebaseProductId viewController:(UIViewController *)viewController completion:(void(^)(TCGBPurchasableReceipt * _Nullable purchasableReceipt, TCGBError * _Nullable error))completion;
...
@param gamebaseProductId         gamebaseProductID which you want to purchase.
@param payload         user define payload
@param viewController  represent to current viewcontroller.
@param completion      completion may return the TCGBPurchasableReceipt instance.<br/>
If there is an error, TCGBError will be returned.
@warning   You should call this method after ```logged in```, otherwise you will get **TCGB_ERROR_NOT_LOGGED_IN** error in the completion.
...
### Usage Example
   ...
   - (void)purchasingItem:(NSString *)gamebaseProductId payload:(NSString *)payload {
       [TCGBPurchase requestPurchaseWithGamebaseProductId:gamebaseProductId payload:payload viewController:self completion:^(TCGBPurchasableReceipt *purchasableReceipt, TCGBError *error) {
           if (error.code == TCGB_ERROR_PURCHASE_USER_CANCELED) {
               dispatch_async(dispatch_get_main_queue(), ^{
                   UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Item Purchase"
                                                                   message:[NSString stringWithFormat:@"You Canceled."]
...
*/
+ (void)requestPurchaseWithGamebaseProductId:(NSString *)gamebaseProductId payload:(nullable NSString *)payload viewController:(UIViewController *)viewController completion:(void(^)(TCGBPurchasableReceipt * _Nullable purchasableReceipt, TCGBError * _Nullable error))completion;
 ...
 */
+ (void)requestRetryTransactionWithCompletion:(void(^)(TCGBPurchasableRetryTransactionResult * _Nullable transactionResult, TCGBError * _Nullableerror))completion DEPRECATED_MSG_ATTRIBUTE("SDK retries transaction automatically in internal process. You don't need to call explicitly. Result is always success.");
 ...
 */
+ (void)setPromotionIAPHandler:(void(^)(TCGBPurchasableReceipt * _Nullable purchasableReceipt, TCGBError * _Nullable error))handler;
