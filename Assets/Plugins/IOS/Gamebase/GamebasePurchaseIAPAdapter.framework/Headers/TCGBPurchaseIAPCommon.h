...
#define GamebasePurchaseIAPAdapterVersion @"2.29.0"
...
- (void)requestPurchaseWithItemSeq:(long)itemSeq gamebasePayload:(NSString *)gamebasePayload viewController:(UIViewController *)viewController completion:(void(^)(TCGBPurchasableReceipt *purchasableReceipt, TCGBError *error))completion;
...
- (void)requestPurchaseWithMarketItemId:(NSString *)productId payload:(NSString *)payload gamebasePayload:(NSString *)gamebasePayload viewController:(UIViewController *)viewController completion:(void(^)(TCGBPurchasableReceipt *purchasableReceipt, TCGBError *error))completion;
