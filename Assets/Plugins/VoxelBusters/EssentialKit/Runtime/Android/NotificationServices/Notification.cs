...
#region Base class implementation
            ...
            if(m_trigger == null)
            {
                ...
                if (trigger != null)
                {
                    ...
                    else if(m_instance.HasLocationTrigger())
                    {
                        ...
                        {
                            Latitude = locationNotificationTrigger.GetLocationCoordinate().X,
                            Longitude = locationNotificationTrigger.GetLocationCoordinate().Y
                        };
        ...
        {
            return m_instance.IsLaunchNotification;
        }
