...
namespace VoxelBusters.EssentialKit.GameServicesCore.Simulator
{
    internal sealed class Score : ScoreBase
    {
        ...
        {
            return (data != null) ? new Score(data.LeaderboardPlatformId, data.PlayerId, 1, data.Value) : null; 
        }
        ...
        {
            Error   error;
            GameServicesSimulator.Instance.ReportLeaderboardScore(LeaderboardId, Value, out error);
