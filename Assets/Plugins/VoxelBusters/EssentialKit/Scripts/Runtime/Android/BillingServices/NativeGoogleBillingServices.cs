...
#endif
            Call(Native.Method.kRestorePurchases, new object[] { userTag, listener } );
        }
...
#endif
                Call(Native.Method.kBuyProduct, new object[] { productIdentifier, userTag } );
            });
        }
...
#endif
            Call(Native.Method.kFinishBillingTransaction, new object[] { transactionId, isValidPurchase } );
        }
