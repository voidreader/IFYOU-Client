...
#endif
            Call(Native.Method.kSetNotificationType, new object[] { NativeNotificationTypeHelper.CreateWithValue(type) } );
        }
...
#endif
            Call(Native.Method.kRequestSystemNotificationSettings, new object[] { listener } );
        }
